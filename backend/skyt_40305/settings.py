"""
Django settings for skyt_40305 project.
...
WSGI_APPLICATION = 'skyt_40305.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "skyt_40305 API",
    "DESCRIPTION": "API documentation for skyt_40305 App",
    "VERSION": "v1",
}
